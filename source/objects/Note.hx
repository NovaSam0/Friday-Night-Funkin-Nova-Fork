...
class Note extends FlxSprite
{
	...
	**/
	...
	private function set_noteType(value:String):String {
		noteSplashData.texture = PlayState.SONG != null ? PlayState.SONG.splashSkin : 'notes/noteSplashes/noteSplashes';
		defaultRGB();
		...
		if(noteData > -1 && noteType != value) {
			switch(value) {
				case 'Hurt Note':
					...
					noteSplashData.texture = 'notes/noteSplashes/noteSplashes-electric';
