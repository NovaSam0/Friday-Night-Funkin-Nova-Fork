...
class VisualsSettingsSubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		// options
		var noteSkins:Array<String> = Mods.mergeAllTextsNamed('images/notes/noteSkins/list.txt');
		...
		var noteSplashes:Array<String> = Mods.mergeAllTextsNamed('images/notes/noteSplashes/list.txt');
